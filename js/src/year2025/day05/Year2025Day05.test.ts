import {solve1, solve2a, solve2} from "./Year2025Day05"
...
describe("Year2025 Day05", () => {
    ...
    it('example2a', () => expect(solve2a(loadLinesSplitByBlankLine('example.txt')[0])).toBe(14));
    it('real2a', () => expect(solve2a(loadLinesSplitByBlankLine('data.txt')[0])).toBe(344771884978261));
